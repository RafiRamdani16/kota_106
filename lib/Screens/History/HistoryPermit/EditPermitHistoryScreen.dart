...
class EditPermitHistoryScreen extends GetView<PermitController> {
  ...
  Widget build(BuildContext context) {
    controller.permitSelectedDate.value =
        DateTime.parse(permitModel.permitDate);
    controller.permitStartTime.value = TimeOfDay.fromDateTime(
        DateFormat("HH:mm").parse("${permitModel.permitStartTime}"));
    controller.permitEndTime.value = TimeOfDay.fromDateTime(
        DateFormat("HH:mm").parse("${permitModel.permitEndTime}"));
    controller.permitDescription.text = permitModel.permitDescription;
    return Scaffold(
      appBar: AppBar(
        elevation: 0,

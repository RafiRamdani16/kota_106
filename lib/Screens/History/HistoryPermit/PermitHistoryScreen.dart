...
import 'package:kota_106/Screens/History/HistoryPermit/DetailPermitHistoryScreen.dart';
import 'package:sizer/sizer.dart';
import '../HistoryScreen.dart';

class PermitHistoryScreen extends GetView<HistoryController> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: controller.getPermitHistory(),
        ...
        AnimationLimiter(
            child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: controller.permitHistory.length,
                  itemBuilder: (BuildContext context, int index) {
                    if (controller.permitHistory.length < 1) {
                      return Container(
                          child: Center(
                        child: Text(
                          "Tidak Ada Riwayat",
                                              ...
                                              onPressed: () {
                                                showModalBottomSheet(
                                                    ...
                                                    builder:
                                                      ...
                                                      return DetailPermitHistoryScreen(
                                                          controller
                                                                  .permitHistory[
                                                              index]);
                                                    });

...
class HistoryPresensiPage extends GetView<HistoryController> {
  ...
  Widget build(BuildContext context) {
    return  Obx(() {
        return controller.isThereItem.value == false
                      ...
                      child: SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder:
                              ...
                              controller.currentCheckinDate(controller
                                  .attendanceHistory[index].checkinAt);
                              controller.currentCheckOutDate(controller
                                  .attendanceHistory[index].checkoutAt);
                                                            ...
                                                            ElevatedButton(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    Text(
                                                                      'DETAIL',
                                                                      style: TextStyle(fontFamily: 'ROBOTO', fontSize: 10, color: Colors.amber),
                                                                    ),
                                                                    Icon(

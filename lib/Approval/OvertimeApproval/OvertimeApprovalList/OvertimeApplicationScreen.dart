        ...
        AnimationLimiter(
            child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: controller.overtimeApproval.length,
                  itemBuilder: (BuildContext context, int index) {
                    if (controller.overtimeApproval.length < 1) {
                      return Container(
                          child: Center(
                        child: Text(
                          "Tidak Ada Riwayat",
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          controller
                                              .overtimeApproval[index].userName,
                                          style: TextStyle(
                                              fontSize: 10.sp,
                                        ...
                                        Text(
                                          controller
                                              .overtimeApproval[index].position,
                                              ...
                                              onPressed: () {
                                                showModalBottomSheet(
                                                    ...
                                                    builder:
                                                      ...
                                                      return OvertimeApprovalDetailScreen(
                                                          controller
                                                                  .overtimeApproval[
                                                              index]);
                                                    });

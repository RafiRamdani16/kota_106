...
import '../LeaveApprovalDetail/LeaveApprovalDetailScreen.dart';

class LeaveApprovalScreen extends GetView<LeaveApprovalController> {
        ...
        AnimationLimiter(
            child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: controller.leaveApplication.length,
                  itemBuilder: (BuildContext context, int index) {
                    if (controller.leaveApplication.length < 1) {
                      return Container(
                          child: Center(
                        child: Text(
                          "Tidak Ada Riwayat",
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          controller
                                              .leaveApplication[index].userName,
                                          style: TextStyle(
                                              fontSize: 10.sp,
                                        ...
                                        Text(
                                          controller
                                              .leaveApplication[index].position,
